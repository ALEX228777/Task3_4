...
namespace Task3_1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            arrayprint[1] = new One_dimension<double>(randi, doublei);
            arrayprint[2] = new One_dimension<string>(randi, stringi);
            arrayprint[3] = new One_dimension<bool>(randi, booli);
            arrayprint[4] = new Two_dimension<int>(randi, inti);
            arrayprint[5] = new Two_dimension<double>(randi, doublei);
            arrayprint[6] = new Two_dimension<string>(randi, stringi);
